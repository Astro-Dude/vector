      ...
      <div className="min-h-screen bg-black">
        ...
        <div className="pt-28 md:pt-36 p-4 md:p-8 overflow-y-auto">
          <div className="max-w-3xl mx-auto">
            ...
            {/* Incomplete Interview Indicator */}
            {selectedResult.status === 'incomplete' && (
              <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4 mb-6 flex items-center gap-3">
                ...
                <div>
                  <p className="text-yellow-400 font-medium">Interview Ended Early</p>
                  <p className="text-yellow-400/70 text-sm">
                    {selectedResult.questionsAnswered} of {selectedResult.totalQuestions} questions answered
                  </p>
                </div>
              </div>
            )}
