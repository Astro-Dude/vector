...
const questions = [
  {
    question: 'Consider the expression 7^679×3^421. Determine the digit in the units (ones) place of the resulting product.',
    answer: '9',
    category: 'maths',
    difficulty: 'easy'
  },
...
If a candidate is not selected (i.e., they do not get into SST), what is the probability(in percentage) that they had actually cleared the NSET exam?`,
    answer: '6.5%',
    category: 'maths',
    difficulty: 'hard'
  },
