        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.linkedin.com/company/vector-ed/" className="text-gray-500 hover:text-blue-600">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <a href="#" className="text-base text-gray-600 hover:text-blue-600">
                  Test Series
                </a>
              </li>
              <li>
